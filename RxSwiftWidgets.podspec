#
#  Be sure to run `pod spec lint RxSwiftWidgets.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "A short description of RxSwiftWidgets."
  ...
  spec.homepage     = "http://EXAMPLE/RxSwiftWidgets"
  ...
  spec.source_files  = "Sources/RxSwiftWidgets", "Sources/RxSwiftWidgets/**/*.{h,m}"
